            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li >
                                <i class="fa fa-file"></i> Contacto
                            </li>
                            <li class="active">
                                <i class="fa fa-file"></i> Actualiar Contacto
                            </li>
                        </ol>
                    </div>
                </div>
               ...
               <div class="row">
                   ...
                   <?php
                        ...
                        $teste = $get_id;
                        $sql = "SELECT * FROM contacto WHERE id = $teste";
                        $select_by_id = mysqli_query($connection,$sql);
                        if(!$select_by_id){
                        ...
                        while($row = mysqli_fetch_assoc($select_by_id)){
                            $db_id = $row['id'];
                            $db_telefone = $row['telefone'];
                            $db_movel = $row['movel'];
                            $db_fax = $row['fax'];
                            $db_email = $row['email'];
                            $db_endereco = $row['endereco'];
                            $db_movel2 = $row['movel_2'];
                       ...
                       <input type="hidden" name="id" value="<?php  echo  $get_id ?>">
                            <div class="form-group">
                                <input class="input form-control" type="number" name="telefone" value="<?php  echo  $db_telefone ?>" required="required">
                            </div>
                            <div class="form-group">
                                <input class="input form-control" type="number" name="movel" value="<?php  echo  $db_movel ?>" required="required">
                            </div>
                            <div class="form-group">
                                <input class="input form-control" type="number" name="movel2" value="<?php  echo  $db_movel2 ?>" required="required">
                            </div>
                            <div class="form-group">
                                <input class="input form-control" type="number" name="fax" value="<?php  echo  $db_fax ?>" required="required">
                            </div>
                            <div class="form-group">
                                <input class="input form-control" type="email" name="email" value="<?php  echo  $db_email ?>" required="required">
                            </div>
                            <div class="form-group">
                                <input class="input form-control" type="text" name="endereco" value="<?php  echo  $db_endereco ?>" required="required">
                            </div>
