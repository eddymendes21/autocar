            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Actualizar Banner
                            </li>
                        </ol>
                    </div>
                </div>
               ...
               <div class="row">
                   ...
                   <?php
                       ...
                       $teste = $get_id;
                        $sql = "SELECT * FROM banner WHERE id = $teste";
                       ...
                       <input type="hidden" name="id" value="<?php  echo  $get_id ?>">
                            <div class="form-group">
                                <input class="input form-control" type="text" name="titulo" value="<?php echo $db_tipo;  ?>" required="required">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input class="input form-control" type="number" name="ano" value="<?php echo $db_ano;  ?>" required="required">
                            </div>
                            <div class="form-group">
