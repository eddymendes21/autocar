                               ...
                               <?php 
                                  global $connection;
                                    ...
                                    while($row = mysqli_fetch_assoc($resolt)){
                                        ...
                                        echo "<tr>";
                                        echo "<td>$db_id</td>";
                                        echo "<td>$db_telefone</td>";
                                        echo "<td>$db_movel</td>";
                                        echo "<td>$db_movel2</td>";
                                        echo "<td>$db_fax</td>";
                                        echo "<td>$db_email</td>";
                                        echo "<td>$db_endereco</td>";
                                        echo "<td><a href='update_contacto.php?v_id={$db_id}'>Editar</a></td>";
                                        //echo "<td><a href='all_contact.php?delete={$db_id}'>Delete</a></td>";
                                        echo "</tr>";
                                    }
