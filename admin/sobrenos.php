               ...
               <div class="row">
                   ...
                   <?php
                    if (isset($_GET['v_id'])) {
                       ...
                       $teste = $get_id;
                        $sql = "SELECT * FROM about WHERE id = $teste";
                   ...
                   ?>
                       <form action="sobrenos.php" method="post" >
                            <div class="form-group">
                            <input type="hidden" name="id" value="<?php  echo  $get_id ?>">
                                <textarea rows="8" id="message" class="input form-control" name="message" placeholder="Message..." required="required"><?php echo $db_sobre;  ?></textarea></textarea>
                            </div>
