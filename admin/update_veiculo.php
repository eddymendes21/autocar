            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li >
                                <i class="fa fa-file"></i> Lista de Carro
                            </li>
                            <li class="active">
                                <i class="fa fa-file"></i> Actualizar Veiculo
                            </li>
                        </ol>
                    </div>
                </div>
               ...
               <div class="row">
                   ...
                   <div class="col-md-6"><?php
                       ...
                       $teste = $get_id;
                        $sql = "SELECT * FROM veiculo WHERE id = $teste";
                       ...
                       <form action="update_veiculo.php" method="post" enctype="multipart/form-data">
                             <input type="hidden" name="v_id" value="<?php  echo  $get_id ?>">
                            <div class="form-group">
                                <input class="input form-control" type="text" name="marca" value="<?php echo $db_marca;  ?>" required="required">
                            </div>
                            <div class="form-group">
                                <input class="input form-control" type="text" name="modelo" value="<?php echo $db_modelo;  ?>" required="required">
                            </div>
                            <div class="form-group">
                                <input class="input form-control" type="number" name="preco" value="<?php echo $db_preco;  ?>" required="required">
                            </div>

                           <div class="form-group">
                           <img width="100" src="../<?php echo $db_image;  ?>" alt=""> 
                           <input type="file" name="fileToUpload" id="fileToUpload" required="required">
                            </div>
                            <div class="form-group">
                                <textarea rows="8" maxlength="150" id="discricao" class="input form-control" name="discricao"  required="required"><?php echo $db_discricao;  ?></textarea>
                            </div>
