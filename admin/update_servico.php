            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li >
                                <i class="fa fa-file"></i> Serviço
                            </li>
                            <li class="active">
                                <i class="fa fa-file"></i> Actualizar Serviço
                            </li>
                        </ol>
                    </div>
                </div>
               ...
               <div class="row">
                   ...
                   <?php
                       ...
                       $teste = $get_id;
                        $sql = "SELECT * FROM servico WHERE id = $teste";
                       ...
                       <input type="hidden" name="id" value="<?php  echo  $get_id ?>">
                            ...
                            <input class="input form-control" type="text" id="nome" name="nome"value="<?php echo $db_nome;  ?>" required="required">
                            </div>
                            <div class="form-group">
                                <textarea rows="10"  id="mensagem" class="input form-control" name="mensagem" placeholder="Message..." required="required"><?php echo $db_conteudo;  ?></textarea>
                            </div>
                        <br>
