        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Inserir Banner
                            </li>
                        </ol>
                    </div>
                </div>
               ...
               <div class="row">
                   ...
                   <div class="col-md-6">
                       <form action="inserir_banner.php" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <input class="input form-control" type="text" name="titulo" placeholder="Titulo do banner" required="required">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input class="input form-control" type="number" name="ano" placeholder="Ano do Veiculo" required="required">
                            </div>
                            <div class="form-group">
