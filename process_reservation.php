...
$expected = ['marca','min','max','name','surname','email','num_doc', 'telefone', 'address','origin_country','nationality','info'];
$required = ['marca','min','max','name','surname','email', 'telefone', 'address','origin_country','nationality'];
...
if (!$errors && !$missing) {
    ...
    $replacements = [
        'cyberdel@cvtelecom.cv'  =>
            ['#subject#' => 'Pedido de Reserva Delcar Renta-A-Car'],
        $email  =>
            ['#subject#' => 'Pedido de Reserva Delcar Renta-A-Car']
   ];
    ...
    try {
       ...
       $message = Swift_Message::newInstance()
            ...
            $image_ilha = $message->embed(Swift_Image::fromPath('assets/images/santiago.png'));
...
<title>Delcar Renta-A-Car </title>
</head>
...
<tr>
<td style="text-align:center; padding:2em;"><img src="$image_logo" class="img-responsive"></td>
</tr>
<tr>
<td style="padding-top: 0.5em">
<h1 style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', Verdana, sans-serif; color: #0E618C; text-align:
center">Pedido de Reserva Delcar Renta-A-Car</h1>
</td>
</tr>
<tr>
